...
echo ===================================================
powershell -Command "Write-Host '   JoyViewer Premium Compiler (v4.2)   ' -ForegroundColor Black -BackgroundColor Cyan"
echo ===================================================
echo.
...
if exist "dist\JoyViewer.exe" (
    ...
    :: Rename to include version v4.2 for the final build
    copy /Y "dist\JoyViewer.exe" "dist\JoyViewer-v4.2.exe" >nul
    if %errorlevel% equ 0 (
        powershell -Command "Write-Host '[+] Version-stamped copy created: dist\JoyViewer-v4.2.exe' -ForegroundColor Green"
    )
...
echo ===================================================
echo [Location] e:\joyviewer\dist\JoyViewer-v4.2.exe
echo.
pause
exit /b 0
